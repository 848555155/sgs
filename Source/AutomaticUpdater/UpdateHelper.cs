...
{
    // Constants
    private const int MaxSendRetries = 20;
    private const int MilliSecsBetweenRetry = 250;

    // 20 * 250 = 5000 ms = 5 seconds for an error to show

    private Process ClientProcess;
    private string m_CompleteWULoc;
    private string m_wyUpdateLocation = "wyUpdate.exe";
    ...
    private readonly Stack<UpdateHelperData> sendBuffer = new Stack<UpdateHelperData>(1);
    private readonly List<UpdateHelperData> receivedBuffer = new List<UpdateHelperData>();
    ...
    private void TryToConnectToPipe(string pipename)
    {
    ...
    private bool RetrySend(byte[] message)
    {
    ...
    private int ClientWindowHandleToShow;
    ...
    private void SendAsync(UpdateHelperData uhd)
    {
    ...
    private void SafeProcessReceivedMessage(byte[] message)
    {
    ...
    private void ProcessReceivedMessage(UpdateHelperData data)
    {
