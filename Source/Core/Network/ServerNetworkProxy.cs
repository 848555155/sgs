...
public class ServerNetworkProxy : IPlayerProxy
{
    ...
    private readonly ServerAsyncProxy proxy;
    ...
    private ISkill skillAnswer;
    private List<Card> cardsAnswer;
    private List<Player> playersAnswer;
    private List<List<Card>> choiceAnswer;
