...
{
    private readonly ClientNetworkProxy proxy;
    private readonly List<ClientNetworkProxy> inactiveProxies;
    private Prompt prompt;
    private List<OptionPrompt> questions;
    ...
    private Thread pendingUiThread;
