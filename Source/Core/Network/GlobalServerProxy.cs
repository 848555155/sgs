...
public class GlobalServerProxy : IGlobalUiProxy
{
    ...
    private Semaphore semWake;
    private Semaphore semDone;
    private ISkill answerSkill;
    private List<Card> answerCard;
    private List<Player> answerPlayer;
    ...
    private Dictionary<Player, int> manswerMCQ;
...
#pragma warning restore SYSLIB0006 // 类型或成员已过时
    ...
    private Dictionary<Player, ISkill> manswerSkill;
    private Dictionary<Player, List<Card>> manswerCards;
    private Dictionary<Player, List<Player>> manswerPlayers;
...
#pragma warning restore SYSLIB0006 // 类型或成员已过时
    ...
    private Dictionary<Player, List<Card>> answerHero;
