...
public class TianYi : ActiveSkill
{
    ...
    private class TianYiRemoval : Trigger
    {
        public override void Run(GameEvent gameEvent, GameEventArgs eventArgs)
        {
            if (eventArgs.Source != Owner)
    ...
    private class TianYiPassiveSkill : TriggerSkill
    {
    ...
    private static readonly PlayerAttribute TianYiUsed = PlayerAttribute.Register("TianYiUsed", true);
}
