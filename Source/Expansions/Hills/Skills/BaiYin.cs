...
public class BaiYin : TriggerSkill
{
    ...
    private class JiLveGuiCai : GuiCai
    {
    ...
    private class JiLveFangZhu : FangZhu
    {
    ...
    private class JiLveJiZhi : TriggerSkill
    {
        public JiLveJiZhi()
        {
    ...
    private class JiLveWanSha : AutoVerifiedActiveSkill
    {
        public JiLveWanSha()
        {
            MinCards = 0;
        ...
        private static readonly PlayerAttribute WanShaStatus = PlayerAttribute.Register("JiLveWanSha", false, false, true);

        private class WanShaRemoval : Trigger
        {
    ...
    private class JiLveZhiHeng : ZhiHeng
    {
