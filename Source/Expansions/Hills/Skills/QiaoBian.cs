...
public class QiaoBian : TriggerSkill
{
    ...
    private class MoveVerifier : CardsAndTargetsVerifier
    {
        public MoveVerifier()
        {
            MaxCards = 0;
    ...
    private class SkipOnlyVerifier : CardsAndTargetsVerifier
    {
    ...
    private class QiaoBianMoveVerifier : ICardChoiceVerifier
    {
        ...
        private readonly Player source, dest;
