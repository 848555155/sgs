...
{
    private List<Card> GuZhengCards;
    private List<Card> belongToCurrent;

    private class GuZhengVerifier : ICardChoiceVerifier
    {
        ...
        private readonly List<Card> belongToCurrent;
