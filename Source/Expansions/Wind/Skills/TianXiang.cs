...
public class TianXiang : TriggerSkill
{
    ...
    private static readonly CardAttribute TianXiangDamage = CardAttribute.Register("TianXiangDamage");
    private static readonly PlayerAttribute TianXiangTarget = PlayerAttribute.Register("TianXiangTarget");
