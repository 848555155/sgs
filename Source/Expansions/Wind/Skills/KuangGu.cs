...
{
    private class KuangGuRecover : Trigger
    {
        ...
        private readonly KuangGu skill;
    ...
    private static readonly CardAttribute KuangGuUsable = CardAttribute.Register("KuangGuUsable");
}
