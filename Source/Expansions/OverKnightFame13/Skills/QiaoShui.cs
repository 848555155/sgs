...
public class QiaoShui : TriggerSkill
{
    ...
    private class QiaoShuiRemoval : Trigger
    {
        public override void Run(GameEvent gameEvent, GameEventArgs eventArgs)
        {
            if (eventArgs.Source != Owner)
        ...
        private readonly Trigger loseTrigger;
    ...
    private class QiaoShuiVerifier : CardsAndTargetsVerifier
    {
        private readonly CardHandler handler;
        private readonly List<Player> existingTargets;
        private readonly ICard existingCard;
    ...
    public class QiaoShuiWinTrigger : Trigger
    {
        ...
        private bool used;
        private readonly TriggerSkill theSkill;
    ...
    private class QiaoShuiWinRemoval : Trigger
    {
        public override void Run(GameEvent gameEvent, GameEventArgs eventArgs)
        {
            if (eventArgs.Source != Owner)
        ...
        private readonly Trigger winTrigger;
