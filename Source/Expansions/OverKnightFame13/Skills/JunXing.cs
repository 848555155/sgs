...
public class JunXing : AutoVerifiedActiveSkill
{
    ...
    private class JunXingVerifier : CardsAndTargetsVerifier
    {
        private readonly HashSet<CardCategory> cc;
    ...
    private static readonly PlayerAttribute JunXingUsed = PlayerAttribute.Register("JunXingUsed", true);
}
