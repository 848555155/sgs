...
{
    private class QiuYuanVerifier : CardsAndTargetsVerifier
    {
    ...
    private class QiuYuanGiveCardVerifier : CardsAndTargetsVerifier
    {
    ...
    private readonly QiuYuanVerifier qiuYuanVerifier;
