...
public class LiHun : ActiveSkill
{
    ...
    private class LiHunVerifier : CardsAndTargetsVerifier
    {
    ...
    private class LiHunGiveBack : Trigger
    {
    ...
    private static readonly PlayerAttribute LiHunUsed = PlayerAttribute.Register("LiHunUsed", true);
}
