...
{
    private static readonly PrivateDeckType ZuiXiangDeck = new PrivateDeckType("ZuiXiang", true);
    ...
    private void CardUseStopper(Player Owner, GameEvent gameEvent, GameEventArgs eventArgs)
    {
        bool hasBasic = false;
        bool hasTool = false;
    ...
    private void CardEffectStopper(Player Owner, GameEvent gameEvent, GameEventArgs eventArgs)
    {
        bool hasBasic = false;
        bool hasTool = false;
        foreach (var card in Game.CurrentGame.Decks[Owner, ZuiXiangDeck])
