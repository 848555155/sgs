...
{
    private class JunWeiGiveShanVerifier : CardsAndTargetsVerifier
    {
    ...
    private class JunWeiVerifier : CardUsageVerifier
    {
    ...
    private class JunWeiShowCardVerifier : CardUsageVerifier
    {
        public override VerifierResult FastVerify(Player source, ISkill skill, List<Card> cards, List<Player> players)
        {
    ...
    private void LoseJunWei(Player Owner)
    {
        DiscardedTempCard();
    }

    private void DiscardedTempCard()
    {
    ...
    private readonly List<Player> junweiTarget;
