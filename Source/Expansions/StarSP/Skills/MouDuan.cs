...
/// </summary>
internal class MouDuan : TriggerSkill
{
    private class MouDuanVerifier : CardsAndTargetsVerifier
    {
    ...
    private void loseMouDuan(Player Owner)
    {
        if (Owner[WuMark] != 0)
        {
            Owner[WuMark] = 0;
    ...
    private readonly ISkill mdJiAng;
    private readonly ISkill mdQianXun;
    private readonly ISkill mdYingZi;
    private readonly ISkill mdKeJi;
    private static readonly PlayerAttribute WuMark = PlayerAttribute.Register("Wu", false, true);
    private static readonly PlayerAttribute WenMark = PlayerAttribute.Register("Wen", false, true);
}
