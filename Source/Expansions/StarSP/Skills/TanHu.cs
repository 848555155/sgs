...
public class TanHu : AutoVerifiedActiveSkill
{
    ...
    private class TanHuPassiveSkill : TriggerSkill
    {
    ...
    private static readonly PlayerAttribute TanHuWin = PlayerAttribute.Register("TanHuWin", true);
    private static readonly PlayerAttribute TanHuUsed = PlayerAttribute.Register("TanHuUsed", true);
}
