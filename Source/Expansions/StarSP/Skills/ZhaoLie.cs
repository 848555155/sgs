...
{
    private class ZhaoLieVerifier : CardsAndTargetsVerifier
    {
    ...
    private void ZhaoLieProcess(Player Owner, GameEvent gameEvent, GameEventArgs eventArgs)
    {
        ZhaoLieUsed = false;
        basicCards.Clear();
        notBasicCards.Clear();
    ...
    private readonly List<Card> basicCards = new List<Card>();
    private readonly List<Card> notBasicCards = new List<Card>();
    private Player ZhaoLieTarget = null;
    private bool ZhaoLieUsed = false;
    public ZhaoLie()
    {
    ...
    private static readonly CardAttribute ZhaoLieDamage = CardAttribute.Register("ZhaoLieDamage");
}
