...
/// </summary>
internal class SongCi : AutoVerifiedActiveSkill
{
    public SongCi()
    {
        MaxCards = 0;
    ...
    private static readonly PlayerAttribute SongCiTarget = PlayerAttribute.Register("SongCiTarget");
    private static readonly PlayerAttribute SongCiStatus = PlayerAttribute.Register("SongCi", false, false, true);
}
