...
{
    private class XingWuVerifier : CardsAndTargetsVerifier
    {
    ...
    private class XingWuChoicePlayer : CardsAndTargetsVerifier
    {
    ...
    private static readonly PlayerAttribute CardSuitUsed = PlayerAttribute.Register("CardSuitUsed");
}
