...
public class FuHun : CardTransformSkill
{
    ...
    private class FuHunPassiveSkill : TriggerSkill
    {
        public class RemoveShengPao : Trigger
        {
            ...
            private readonly FuHunPassiveSkill fuhun;
        ...
        private ISkill fhWuSheng;
        private ISkill fhPaoXiao;
    ...
    private static readonly CardAttribute FuHunSha = CardAttribute.Register("FuHunSha");
}
