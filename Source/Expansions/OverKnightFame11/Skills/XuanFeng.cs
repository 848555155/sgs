...
{
    private readonly PlayerAttribute XuanFengUsable = PlayerAttribute.Register("XuanFengUsable", true);
    private readonly PlayerAttribute XuanFengUsed = PlayerAttribute.Register("XuanFengUsed", true);

    private bool canTrigger(Player Owner, GameEvent gameEvent, GameEventArgs eventArgs)
    {
    ...
    private class XuanFengVerifier : CardsAndTargetsVerifier
    {
