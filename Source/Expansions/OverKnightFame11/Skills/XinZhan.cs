...
public class XinZhan : ActiveSkill
{
    ...
    private static readonly int choiceCount = 3;
    private static readonly PlayerAttribute XinZhanUsed = PlayerAttribute.Register("XinZhanUsed", true);
    ...
    private class XinZhanVerifier : ICardChoiceVerifier
    {
        ...
        private static readonly UiHelper helper = new UiHelper() { AdditionalFineGrainedCardChoiceRevealPolicy = new List<bool>() { false, true }, ShowToAll = true };
