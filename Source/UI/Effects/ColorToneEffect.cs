...
public class ColorToneEffect : ShaderEffect
{
    ...
    public static readonly DependencyProperty DesaturationProperty = DependencyProperty.Register("Desaturation", typeof(double), typeof(ColorToneEffect), new UIPropertyMetadata(0.5D, PixelShaderConstantCallback(0)));
    public static readonly DependencyProperty TonedProperty = DependencyProperty.Register("Toned", typeof(double), typeof(ColorToneEffect), new UIPropertyMetadata(0.5D, PixelShaderConstantCallback(1)));
    ...
    static ColorToneEffect()
    {
        ...
        {
            UriSource = Global.MakePackUri("ShaderSource/ColorTone.ps")
        };
    }
