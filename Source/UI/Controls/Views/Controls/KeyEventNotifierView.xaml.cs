...
{
    private readonly DispatcherTimer _cleanUpCounter;
    private int _currentTime;

    private readonly EventHandler _cleanUpHandler;
    ...
    private void KeyEventNotifierView_Unloaded(object sender, RoutedEventArgs e)
    {
        _cleanUpCounter.Tick -= _cleanUpHandler;
    }

    private static readonly int _cleanUpElapsedTimeThreshold = 3;
    ...
    private readonly List<bool> _disappearing;
