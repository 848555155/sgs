...
public class LogFormatter
{
    ...
    public static IList<Inline> TranslateLogEvent(Prompt custom, bool useUICard = true)
    {
        ...
        foreach (object arg in custom.Values)
        {
            ...
            else if (arg is Prompt) value.Add(new Run(Translate(arg as Prompt)));
            if (value.Count == 0)
            {
    ...
    private static readonly Brush RedBrush = new SolidColorBrush(new Color() { R = 204, G = 0, B = 0, A = 255 });
    private static readonly Brush OrangeBrush = new SolidColorBrush(new Color() { R = 255, G = 102, B = 0, A = 255 });
    private static readonly Brush YellowBrush = new SolidColorBrush(Colors.Yellow);
    private static readonly Brush GreenBrush = new SolidColorBrush(new Color() { R = 0, G = 204, B = 0, A = 255 });
    private static readonly Brush DarkGreenBrush = new SolidColorBrush(new Color() { R = 104, G = 135, B = 41, A = 255 });
    ...
    private static readonly ResourceDictionary _imageDict;
