...
public class CardStack : Canvas
{
    ...
    private void CardStack_SizeChanged(object sender, SizeChangedEventArgs e)
    {
        RearrangeCards();
    }
    ...
    private static readonly double _extraSpaceForHighlightedCard = 30d;
    ...
    public void RearrangeCards(IList<CardView> cards)
    {
        ...
        for (int i = 0; i < cards.Count; i++)
        {
            ...
            card.SetValue(ZIndexProperty, zindex + i);
    ...
    private readonly double _cardOpacityChangeAnimationDurationSeconds = 0.5d;
