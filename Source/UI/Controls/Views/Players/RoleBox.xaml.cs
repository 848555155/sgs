...
public partial class RoleBox : UserControl
{
    ...
    private void RoleBox_Unloaded(object sender, RoutedEventArgs e)
    {
    ...
    private void RoleBox_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
    {
