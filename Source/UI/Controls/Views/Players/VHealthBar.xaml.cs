...
public partial class VHealthBar : UserControl
{
    ...
    private void Repaint()
    {
        ...
        if (maxHealth > 5)
        {
            ...
            spMaxHealthText.HorizontalAlignment = HorizontalAlignment.Center;
            spLargeHealth.Children.Insert(0, spMaxHealthText);
            Image slashImage = DigitToImage(-1, healthRange);
            slashImage.Margin = margin;
            slashImage.HorizontalAlignment = HorizontalAlignment.Center;
            ...
            spHealthText.HorizontalAlignment = HorizontalAlignment.Center;
        ...
        else
        {
            ...
            for (i = 0; i < health; i++)
            {
                ...
                bloodDrop.HorizontalAlignment = HorizontalAlignment.Center;
