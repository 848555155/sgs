...
{
    private static readonly Dictionary<string, int> _soundsCount = new Dictionary<string, int>();
    private static readonly Dictionary<string, string> _soundsPath = new Dictionary<string, string>();
    private static readonly Dictionary<string, int> _soundsRotation = new Dictionary<string, int>();
    private static readonly Random _soundPicker = new Random(DateTime.Now.Millisecond);
